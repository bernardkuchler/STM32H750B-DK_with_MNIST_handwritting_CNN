...
#define AI_NET_OBJ_INSTANCE g_mnist_nn
 
#undef AI_MNIST_NN_MODEL_SIGNATURE
#define AI_MNIST_NN_MODEL_SIGNATURE     "0x5063275478fc598baf866d06a6f789bd"
...
#define AI_TOOLS_DATE_TIME   "Fri Jun 28 13:05:18 2024"

#undef AI_TOOLS_COMPILE_TIME
#define AI_TOOLS_COMPILE_TIME    __DATE__ " " __TIME__

#undef AI_MNIST_NN_N_BATCHES
#define AI_MNIST_NN_N_BATCHES         (1)

static ai_ptr g_mnist_nn_activations_map[1] = AI_C_ARRAY_INIT;
static ai_ptr g_mnist_nn_weights_map[1] = AI_C_ARRAY_INIT;
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 373288, 1, 1),
    373288, NULL, NULL),
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 31424, 1, 1),
    31424, NULL, NULL),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_MNIST_NN_IN_NUM, &input_0_output),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_MNIST_NN_OUT_NUM, &dense_1_output),
  &conv2d_conv2d_layer, 0xe091600c, NULL)
  ...
  ai_handle network, ai_network_report* report)
{
  ...
  {
    ai_network_report r = {
      .model_name        = AI_MNIST_NN_MODEL_NAME,
      .model_signature   = AI_MNIST_NN_MODEL_SIGNATURE,
...
AI_API_ENTRY
ai_i32 ai_mnist_nn_forward(ai_handle network, const ai_buffer* input)
{
