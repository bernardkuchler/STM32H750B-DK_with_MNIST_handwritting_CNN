/**
  ...
  ******************************************************************************
  */
#ifndef AI_MNIST_NN_H
#define AI_MNIST_NN_H

#include "mnist_nn_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_MNIST_NN_MODEL_NAME          "mnist_nn"
#define AI_MNIST_NN_ORIGIN_MODEL_NAME   "kerascnn"

/******************************************************************************/
#define AI_MNIST_NN_ACTIVATIONS_ALIGNMENT   (4)
#define AI_MNIST_NN_INPUTS_IN_ACTIVATIONS   (4)
#define AI_MNIST_NN_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_MNIST_NN_IN_NUM        (1)

AI_DEPRECATED
#define AI_MNIST_NN_IN \
  ai_mnist_nn_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_MNIST_NN_IN_SIZE { \
  AI_MNIST_NN_IN_1_SIZE, \
}
#define AI_MNIST_NN_IN_SIZE_BYTES { \
  AI_MNIST_NN_IN_1_SIZE_BYTES, \
}
#define AI_MNIST_NN_IN_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_MNIST_NN_IN_1_HEIGHT      (28)
#define AI_MNIST_NN_IN_1_WIDTH       (28)
#define AI_MNIST_NN_IN_1_CHANNEL     (1)
#define AI_MNIST_NN_IN_1_SIZE        (784)
#define AI_MNIST_NN_IN_1_SIZE_BYTES  (3136)

/******************************************************************************/
#define AI_MNIST_NN_OUT_NUM       (1)

AI_DEPRECATED
#define AI_MNIST_NN_OUT \
  ai_mnist_nn_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_MNIST_NN_OUT_SIZE { \
  AI_MNIST_NN_OUT_1_SIZE, \
}
#define AI_MNIST_NN_OUT_SIZE_BYTES { \
  AI_MNIST_NN_OUT_1_SIZE_BYTES, \
}
#define AI_MNIST_NN_OUT_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_MNIST_NN_OUT_1_CHANNEL     (10)
#define AI_MNIST_NN_OUT_1_SIZE        (10)
#define AI_MNIST_NN_OUT_1_SIZE_BYTES  (40)

/******************************************************************************/
#define AI_MNIST_NN_N_NODES (8)
 ...
 */
AI_API_ENTRY
ai_bool ai_mnist_nn_get_report(
  ai_handle network, ai_network_report* report);
 ...
 */
AI_API_ENTRY
ai_handle ai_mnist_nn_destroy(ai_handle network);
 ...
 * @ref ai_mnist_nn_create. Both the activations memory buffer 
 ...
 * using @ref ai_mnist_nn_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_mnist_nn_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_mnist_nn_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_MNIST_NN_*
 * defines into file @ref mnist_nn.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
